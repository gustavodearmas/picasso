...
const Enum_User_Key = {
  ...
  role: "Role",
  statusUser: "Estado",
  nameGuardian: "Nombres del Acudiente ",
  lastNameGuardian: "Apellidos del Acudiente",
  identificationGuardian: "Identificación de Acudiente",
  phoneGuardian: "Teléfono del Acudiente",
  emailGuardian: "Email del Acudiente",
  addressGuardian: "Dirección del Acudiente",
};

...
const Sidebar = () => {
  ...
  return (
    <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-parotia-1 flex flex-wrap items-center justify-between relative md:w-64 z-10">
      <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        <div class="px-6 pt-8">
          <div class="flex items-center justify-between">
            ...
            <button class="flex items-center justify-center p-0.5 rounded bg-parotia-2 focus:outline-none focus:ring-1 focus:ring-gray-500">
              <svg
        ...
        <div class="px-6 pt-4">
          <div class="relative">
            ...
            <input
              type="text"
              class="w-full rounded pl-8 pr-4 py-2.5 text-xs font-light bg-parotia-2 text-gray-400 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-parotia-2"
              placeholder="search"
            />
          </div>
        </div>
        ...
        <div class="px-6 pt-4">
          <ul class="flex flex-col space-y-2">
            <li class="relative text-gray-500 hover:text-white focus-within:text-white">
              ...
              <a
                href="#"
                class="inline-block w-full py-2 pl-8 pr-4 text-xs rounded hover:bg-parotia-2 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-parotia-2"
              >
                Dashboard
              </a>
            </li>
              ...
              <div class="pt-2 pl-4">
                <ul class="flex flex-col pl-2 text-gray-500 border-l border-gray-700">
                  <li>
                    <a
                      href="#"
                      class="inline-block w-full px-4 py-2 text-xs rounded hover:bg-parotia-2 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-white"
                    >
                      Courses
                    </a>
                  </li>
